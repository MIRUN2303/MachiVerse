...
export const USERS: User[] = [
  {
    ...
    stats: {
      ...
      monthlyActivity: [
        { month: 'Jan', matches: 8, wins: 5 },
        { month: 'Feb', matches: 10, wins: 7 },
        { month: 'Mar', matches: 12, wins: 8 },
        { month: 'Apr', matches: 9, wins: 6 },
        { month: 'May', matches: 11, wins: 7 },
        { month: 'Jun', matches: 14, wins: 9 },
        { month: 'Jul', matches: 7, wins: 5 },
      ],
      sportBreakdown: [
        { sport: 'badminton', matches: 45, wins: 30 },
        { sport: 'cricket', matches: 22, wins: 14 },
        { sport: 'cycling', matches: 12, wins: 7 },
        { sport: 'football', matches: 8, wins: 3 },
      ],
      pointsTotal: 1840,
      mvpCount: 5,
    },
  ...
  },
  {
    ...
    stats: {
      ...
      monthlyActivity: [
        { month: 'Jan', matches: 12, wins: 9 },
        { month: 'Feb', matches: 14, wins: 10 },
        { month: 'Mar', matches: 15, wins: 11 },
        { month: 'Apr', matches: 11, wins: 8 },
        { month: 'May', matches: 13, wins: 9 },
        { month: 'Jun', matches: 16, wins: 12 },
        { month: 'Jul', matches: 9, wins: 6 },
      ],
      sportBreakdown: [
        { sport: 'cricket', matches: 60, wins: 44 },
        { sport: 'football', matches: 30, wins: 20 },
  ...
  },
  {
    ...
    stats: {
      ...
      monthlyActivity: [
        { month: 'Jan', matches: 7, wins: 4 },
        { month: 'Feb', matches: 8, wins: 5 },
        { month: 'Mar', matches: 10, wins: 6 },
        { month: 'Apr', matches: 8, wins: 5 },
        { month: 'May', matches: 9, wins: 5 },
        { month: 'Jun', matches: 11, wins: 7 },
        { month: 'Jul', matches: 5, wins: 3 },
      ],
      sportBreakdown: [
        { sport: 'cycling', matches: 35, wins: 22 },
        { sport: 'running', matches: 20, wins: 12 },
  ...
  },
  {
    ...
    stats: {
      ...
      monthlyActivity: [
        { month: 'Jan', matches: 10, wins: 6 },
        { month: 'Feb', matches: 12, wins: 8 },
        { month: 'Mar', matches: 13, wins: 8 },
        { month: 'Apr', matches: 10, wins: 6 },
        { month: 'May', matches: 12, wins: 7 },
        { month: 'Jun', matches: 15, wins: 10 },
        { month: 'Jul', matches: 8, wins: 5 },
      ],
      sportBreakdown: [
        { sport: 'football', matches: 50, wins: 32 },
        { sport: 'basketball', matches: 28, wins: 17 },
  ...
  },
  {
    ...
    stats: {
      ...
      monthlyActivity: [
        ...
        { month: 'Feb', matches: 6, wins: 4 },
        { month: 'Mar', matches: 8, wins: 5 },
        { month: 'Apr', matches: 7, wins: 4 },
        { month: 'May', matches: 8, wins: 5 },
        { month: 'Jun', matches: 9, wins: 5 },
        { month: 'Jul', matches: 4, wins: 2 },
      ],
      sportBreakdown: [
        { sport: 'trekking', matches: 25, wins: 14 },
        { sport: 'cycling', matches: 17, wins: 10 },
  ...
  },
  {
    ...
    stats: {
      ...
      monthlyActivity: [
        { month: 'Jan', matches: 4, wins: 2 },
        { month: 'Feb', matches: 5, wins: 3 },
        { month: 'Mar', matches: 7, wins: 4 },
        { month: 'Apr', matches: 6, wins: 3 },
        { month: 'May', matches: 7, wins: 4 },
        { month: 'Jun', matches: 8, wins: 4 },
        { month: 'Jul', matches: 4, wins: 2 },
      ],
      sportBreakdown: [
        { sport: 'badminton', matches: 20, wins: 11 },
        { sport: 'cricket', matches: 15, wins: 8 },
...
export const GROUPS: Group[] = [
  {
    ...
    memberCount: 6,
    members: [
      { userId: 'u1', role: 'creator', joinedAt: '2024-01-10', stats: { matchesPlayed: 48, wins: 32, losses: 16, winRate: 67, attendanceRate: 96, currentStreak: 6, points: 1240 } },
      { userId: 'u2', role: 'admin',   joinedAt: '2024-01-10', stats: { matchesPlayed: 46, wins: 33, losses: 13, winRate: 72, attendanceRate: 90, currentStreak: 4, points: 1420 } },
      { userId: 'u3', role: 'member',  joinedAt: '2024-02-01', stats: { matchesPlayed: 38, wins: 22, losses: 16, winRate: 58, attendanceRate: 98, currentStreak: 3, points: 880 } },
      { userId: 'u4', role: 'member',  joinedAt: '2024-01-20', stats: { matchesPlayed: 44, wins: 27, losses: 17, winRate: 61, attendanceRate: 86, currentStreak: 8, points: 1120 } },
      { userId: 'u5', role: 'member',  joinedAt: '2024-03-01', stats: { matchesPlayed: 28, wins: 16, losses: 12, winRate: 57, attendanceRate: 92, currentStreak: 2, points: 640 } },
      { userId: 'u6', role: 'member',  joinedAt: '2024-04-10', stats: { matchesPlayed: 22, wins: 11, losses: 11, winRate: 50, attendanceRate: 80, currentStreak: 1, points: 460 } },
    ],
    createdAt: '2024-01-10',
    rules: [
      'Be there on time. Doors at 7:00 PM sharp.',
      'Bring your own shuttles (2 per person).',
      'Respect all players regardless of skill.',
      'Phone goes on silent during matches.',
      'Stay for the full session or inform ahead.',
    ],
    isPrivate: true,
  ...
  },
  {
    ...
    memberCount: 4,
    members: [
      { userId: 'u2', role: 'creator', joinedAt: '2024-02-15', stats: { matchesPlayed: 22, wins: 16, losses: 6, winRate: 73, attendanceRate: 86, currentStreak: 4, points: 680 } },
      { userId: 'u1', role: 'admin',   joinedAt: '2024-02-15', stats: { matchesPlayed: 20, wins: 13, losses: 7, winRate: 65, attendanceRate: 91, currentStreak: 3, points: 520 } },
      { userId: 'u3', role: 'member',  joinedAt: '2024-02-20', stats: { matchesPlayed: 18, wins: 10, losses: 8, winRate: 56, attendanceRate: 95, currentStreak: 2, points: 420 } },
      { userId: 'u5', role: 'member',  joinedAt: '2024-03-05', stats: { matchesPlayed: 15, wins: 8, losses: 7, winRate: 53, attendanceRate: 88, currentStreak: 1, points: 340 } },
    ],
    createdAt: '2024-02-15',
    rules: [
      'Safety first, always.',
      'Inform if you\'re skipping any section.',
      'Help fellow members on difficult trails.',
...
// EVENTS
// =============================================
// Compute a date relative to today
...
export const EVENTS: Event[] = [
  {
    ...
    time: '19:00',
    endTime: '22:00',
    venue: 'Sportorium Badminton Court',
    venueAddress: 'No. 12, Anna Salai, Chennai 600002',
    description: 'Our weekly badminton showdown! 4 leagues, best of 3 format. Bring your A-game and your shuttles. Pizza after the session!',
    ...
    announcements: [
      { id: 'a1', authorId: 'u1', content: '🏸 Courts are booked! See you all at 7 PM sharp. Bring extra shuttles!', createdAt: new Date(Date.now() - 3600000).toISOString(), isPinned: true },
    ],
    gallery: [],
    tags: ['badminton', 'weekly', 'competitive'],
  },
  {
    id: 'e2',
    title: 'Sunday Café Meetup',
    sport: 'cafe',
    groupId: 'g1',
    date: getDate(3),
    time: '10:30',
    endTime: '12:30',
    venue: 'Brew Collective',
    venueAddress: '5th Ave, Nungambakkam, Chennai',
    description: 'Chill Sunday brunch and planning session for next month\'s cricket tournament. Good coffee, good vibes!',
    ...
    isRecurring: false,
    announcements: [
      { id: 'a2', authorId: 'u3', content: '☕ Great place! Reserving a big table for us. Come hungry!', createdAt: new Date(Date.now() - 7200000).toISOString(), isPinned: false },
    ],
    gallery: [],
    tags: ['chill', 'social', 'planning'],
  },
  {
    id: 'e3',
    ...
    time: '08:00',
    endTime: '18:00',
    venue: 'M.A. Chidambaram Stadium (Practice Ground)',
    venueAddress: 'Chepauk, Chennai 600005',
    description: 'Our first full-day cricket tournament! 3 teams, round-robin format. Lunch provided. Bring your cricket kit!',
    ...
    isRecurring: false,
    announcements: [
      { id: 'a3', authorId: 'u2', content: '🏏 CRICKET TOURNAMENT IS ON! Mark your calendars. Teams will be announced 2 days before.', createdAt: new Date(Date.now() - 86400000).toISOString(), isPinned: true },
    ],
    gallery: [],
    tags: ['cricket', 'tournament', 'competitive'],
  },
  {
    id: 'e4',
    title: 'Yelagiri Hills Trek',
    sport: 'trekking',
    groupId: 'g2',
    date: getDate(14),
    time: '05:30',
    endTime: '17:00',
    venue: 'Yelagiri Hills Base Camp',
    venueAddress: 'Yelagiri, Tamil Nadu 635853',
    description: 'Sunrise trek to the summit! Easy-medium difficulty. Perfect for beginners and experienced trekkers alike. Packed breakfast included.',
    ...
    isRecurring: false,
    announcements: [
      { id: 'a4', authorId: 'u5', content: '🥾 Trek is confirmed! Wear good shoes, bring 2L water and sunscreen. Carpooling from Chennai at 4 AM.', createdAt: new Date(Date.now() - 172800000).toISOString(), isPinned: true },
    ],
    gallery: [
  ...
  },
  {
    ...
    venue: 'Sportorium Badminton Court',
    venueAddress: 'No. 12, Anna Salai, Chennai 600002',
    description: 'The legendary Friday session. 4 leagues played, epic matches all around!',
    coverImage: 'https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=800&q=80',
    organizer: 'u1',
    maxSlots: 8,
    ...
    gallery: [
      ...
      'https://images.unsplash.com/photo-1595435193278-6f278e3f3e3c?w=400&q=80',
    ],
...
export const NOTIFICATIONS: Notification[] = [
  {
    ...
    type: 'event',
    title: 'Weekend Badminton Session',
    body: 'Happening in 2 days! Don\'t forget your shuttles 🏸',
  ...
  },
  {
    id: 'n2',
    type: 'attendance',
    title: 'Arjun marked Coming',
    body: 'Weekend Badminton Session now has 3 confirmed players',
  ...
  },
  {
    ...
    body: 'You earned the "Weekend Warrior" badge',
  ...
  },
  {
    ...
    body: 'Mirun: Courts are booked! See you all at 7 PM sharp',
  ...
  },
  {
    ...
    type: 'score',
    title: 'Score Updated',
    body: 'League A — Team Alpha beats Team Beta 21-18!',
  ...
  },
  {
    ...
    body: 'Cricket Tournament starts in 9 days! Confirm your attendance.',
